        ...
        <div className="signup-board">
          ...
          <form onSubmit={handleSubmit}>
            <div className="inputs">
              ...
              ></input>
              <p title="email" data-testid="error1-msg" className="error">
                {formErrors.email}
              </p>
              <input
                type="text"
                ...
                onChange={handleChange}
              ></input>
              <p data-testid="pw1-error-msg" className="error">
                {formErrors.password}
              </p>
              <input
                type="text"
                ...
                onChange={handleChange}
              ></input>
              <p data-testid="pw2-error-msg" className="error">
                {formErrors.password}
              </p>
            </div>
